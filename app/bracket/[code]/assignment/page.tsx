...
export default async function KnockoutAssignmentPage({
  ...
  return (
    <FocusedTaskShell
      ...
      subtitle="Confirm each completed-match winner before placing that team in the next round."
      backHref="/bracket"
    ...
    >
      ...
      >
        ...
        <MatchSummary match={preview.downstreamMatch} showBracketSources />
      </section>
            ...
            >
              ...
              {slot.status === "waiting" ? (
                ...
                <KnockoutAssignmentForm
                  ...
                  intent={slot.status === "assigned" ? "clear" : "assign"}
