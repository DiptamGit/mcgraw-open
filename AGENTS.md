...
4. When a session targets a work item, follow `SESSION_START_PROMPT.md`.
5. Select one work item whose dependencies are complete.
6. Mark that item **In progress** before making changes.
...
Use the project-local frontend design and UI/UX Pro Max guidance for visual
implementation. Preserve the mobile-first requirement and the rules in
`SPEC.md`.
